          ...
          <div className="lg:col-start-2">
            ...
            {order.isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Заказ был успешно оформлен. Товар готов к скачиванию. Детали
                заказа отправлены на почту{" "}
              ...
              <p className="mt-2 text-base text-muted-foreground">
                Ваш заказ в процессе оплаты. Скоро товар будет отправлен на
                почту!
              </p>
            )}
                  ...
                  <li key={product.id} className="flex space-x-6 py-6">
                    ...
                    <div className="flex-auto flex flex-col justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="my-1">Категория: {label}</p>
                      </div>
                      {!order.isPaid ? (
                        <a
                          href={downloadUrl}
            ...
            <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-muted-foreground">
                <p className="text-base">Итог</p>
